...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.0/submodules/qtgamepad-everywhere-src-5.12.0.tar.xz
...
%prep
%setup -q -n qtgamepad-everywhere-src-5.12.0
...
%install
export SOURCE_DATE_EPOCH=1544048852
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtGamepad/5.12.0/QtGamepad/private/qgamepadbackend_p.h
/usr/include/qt5/QtGamepad/5.12.0/QtGamepad/private/qgamepadbackendfactory_p.h
/usr/include/qt5/QtGamepad/5.12.0/QtGamepad/private/qgamepadbackendplugin_p.h
/usr/include/qt5/QtGamepad/5.12.0/QtGamepad/private/qtgamepad-config_p.h
...
/usr/lib64/libQt5Gamepad.so.5.12.0
