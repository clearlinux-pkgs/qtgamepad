...
Version  : 5.13.2
Release  : 16
URL      : https://download.qt.io/official_releases/qt/5.13/5.13.2/submodules/qtgamepad-everywhere-src-5.13.2.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.2/submodules/qtgamepad-everywhere-src-5.13.2.tar.xz
...
%prep
%setup -q -n qtgamepad-everywhere-src-5.13.2
cd %{_builddir}/qtgamepad-everywhere-src-5.13.2
...
%install
export SOURCE_DATE_EPOCH=1572501934
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtgamepad
cp %{_builddir}/qtgamepad-everywhere-src-5.13.2/LICENSE.GPL %{buildroot}/usr/share/package-licenses/qtgamepad/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtgamepad-everywhere-src-5.13.2/LICENSE.LGPLv3 %{buildroot}/usr/share/package-licenses/qtgamepad/d8c5ba35d57eceb2e56ace166048cb901a2d12ed
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtGamepad/5.13.2/QtGamepad/private/qgamepadbackend_p.h
/usr/include/qt5/QtGamepad/5.13.2/QtGamepad/private/qgamepadbackendfactory_p.h
/usr/include/qt5/QtGamepad/5.13.2/QtGamepad/private/qgamepadbackendplugin_p.h
/usr/include/qt5/QtGamepad/5.13.2/QtGamepad/private/qtgamepad-config_p.h
...
/usr/lib64/libQt5Gamepad.so.5.13.2
