...
Version  : 5.11.2
Release  : 6
URL      : http://download.qt.io/official_releases/qt/5.11/5.11.2/submodules/qtgamepad-everywhere-src-5.11.2.tar.xz
Source0  : http://download.qt.io/official_releases/qt/5.11/5.11.2/submodules/qtgamepad-everywhere-src-5.11.2.tar.xz
...
%prep
%setup -q -n qtgamepad-everywhere-src-5.11.2
...
%install
export SOURCE_DATE_EPOCH=1537305615
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/qtgamepad
cp LICENSE.GPL %{buildroot}/usr/share/doc/qtgamepad/LICENSE.GPL
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtGamepad/5.11.2/QtGamepad/private/qgamepadbackend_p.h
/usr/include/qt5/QtGamepad/5.11.2/QtGamepad/private/qgamepadbackendfactory_p.h
/usr/include/qt5/QtGamepad/5.11.2/QtGamepad/private/qgamepadbackendplugin_p.h
/usr/include/qt5/QtGamepad/5.11.2/QtGamepad/private/qtgamepad-config_p.h
...
/usr/lib64/libQt5Gamepad.so.5.11
/usr/lib64/libQt5Gamepad.so.5.11.2
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/qtgamepad/LICENSE.GPL
/usr/share/doc/qtgamepad/LICENSE.LGPLv3
